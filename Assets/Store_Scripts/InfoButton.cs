...
public class InfoButton : MonoBehaviour
{
    ...
    void CheckButtonInfo()
    {
        ...
        {
            case "Chrome Equipment":              //name of store prefab must be this

                StoreManager.instance.ChromeEquipmentInfo.SetActive(true);
                break;
            case "Gold Equipment":              //name of store prefab must be this

                StoreManager.instance.GoldEquipmentInfo.SetActive(true);
                break;
            case "Antique Equipment":              //name of store prefab must be this

                StoreManager.instance.AntiqueEquipmentInfo.SetActive(true);
                break;
            case "Gold Antique Equipment":              //name of store prefab must be this

                StoreManager.instance.GoldAntiqueEquipmentInfo.SetActive(true);
                break;
