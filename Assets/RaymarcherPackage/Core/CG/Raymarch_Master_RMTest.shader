Shader "Matej Vanco/RayMarcher/Mobile/RM Master_RMTest"
{
	...
	{	
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_RMTest.cginc"

				#include "Includes\Mobile\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_RMTest.cginc"	
